myApp.controller('dashboardController', function($scope, $location, dashboardFactory, reminderFactory){
	...
	reminderFactory.getItems($scope.user, function(data){
		console.log("reached getItems on dashboardcontroller");
		$scope.items = data.data;
	})

	reminderFactory.getNames($scope.user, function(data){
	...
	$scope.add = function(){
		...
		reminderFactory.addItem2(other, function(data){
			console.log(data);
		})
		reminderFactory.addItem($scope.item, function(data){
			console.log(data);
			reminderFactory.getItems($scope.user, function(data){
	...
	$scope.done = function(id){
		...
		reminderFactory.done(id, function(data){
			reminderFactory.getItems($scope.user, function(data){
